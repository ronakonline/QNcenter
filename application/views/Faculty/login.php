						...
						<div class="shadow r-10">
							<div class="row grid">
								<div class="col-md-5 white p-5">
									...
									<div class="mb-5">
										<img src="<?php echo base_url(); ?>assets/admin/img/basic/logo.png" width="60"
											 alt="">
									</div>
								...
								<div class="col-md-7 blue p-5 text-white">
									...
									<a href="<?php echo base_url('Institute/register') ?>">
										<button class="btn btn-light s-14 pl-4 pr-4 text-primary">Create Account
										</button>
									</a>
								</div>
							</div>
