<?php $this->load->view('Sadmin/css-links'); ?>
<div id="app">
	<?php echo errormsg();
    echo successmsg();?>
<main>
                ...
                <div class="col-md-8 mx-md-auto">
                    ...
                    <div class="row grid">
                        <div class="col-md-5 white p-5">
                           ...
                           <div class="mb-5">
                               <img src="<?php echo base_url();?>assets/admin/img/basic/logo.png" width="60" alt="">
                           </div>

                            <form class="form-material" action="<?php echo base_url('Sadmin/User/login'); ?>" method="post">
                                <!-- Input -->
                                <div class="body">
