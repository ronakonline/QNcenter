	...
	<aside class="main-sidebar fixed offcanvas shadow" data-toggle='offcanvas'>
		<section class="sidebar">
				...
				<div class="user-panel p-3 light mb-2">
					<div>
						...
						<div class="float-left info">
							<h6 class="font-weight-light mt-2 mb-1"><?php echo $_SESSION['Sadmin']->username; ?></h6>
					...
					<div class="collapse multi-collapse" id="userSettingsCollapse">
						<div class="list-group mt-3 shadow">
							...
							<a href="<?php echo base_url('Sadmin/User/logout'); ?>"
			...
			<ul class="sidebar-menu">
				<li class=""><a href="<?php echo base_url('Sadmin'); ?>">
						<i class="icon icon-dashboard2  s-18"></i> <span>Dashboard</span>
					</a>
				</li>
				<li class=""><a href="<?php echo base_url('Sadmin/institutes'); ?>">
