                ...
                <div class="row">
                        ...
                        <div class="course-entry">
                            ...
                            <ul class="course-info clearfix">
                                <li class="teacher clearfix">
                                    <div class="img">
                                        <img src="images/teacher/9.png" alt="image">
                                    </div>
                                    <div class="info">
                                        <p>Teacher</p>
                            ...
                            <div class="course-image"><img src="images/course/course-single.jpg" alt="image"></div>
                    ...
                    <div class="col-md-4">
                        <div class="course-sidebar">
                                ...
                                <ul>
                                    <li>
                                        <div class="course-thumb">
                                            <a href="#"><img src="images/course/f1.png" alt="image"></a>
                                        </div>
                                        <div class="content">
                            ...
                            </div><!-- /.course-widget-working-hours -->
                        </div><!-- /.course-sidebar -->
                    </div><!-- /.col-md-4 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
